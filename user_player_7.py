...
master.rulers().add({'link': "note", 'position': [3, 5], 'lines': ["1/64"], 'offset': 2})
master.rulers().add({'link': "note", 'position': [4, 5], 'lines': ["1/64"]})
...
master.rulers().add({'link': "retrig", 'position': [5, 1], 'lines': [28], 'offset': 4})
master.rulers().add({'link': "retrig", 'position': [7, 1], 'lines': [28], 'offset': 4})
...
master.rulers().add({'link': "arpeggio", 'position': [10, 1], 'lines': [100, "7", "7", "6.5"], 'offset': 4})
...
master.rulers().add({'link': "arpeggio.gate.auto", 'position': [9, 1], 'lines': [.25, .10, .25, .10, .25, .10], 'offset': 3})
master.rulers().add({'link': "arpeggio.gate.auto", 'position': [15, 1], 'lines': [1, .90, .50, .80], 'offset': 3})
master.rulers().add({'link': "arpeggio.rate.auto", 'position': [8, 1], 'lines': [.25, 4, 1, .5, 2, 8], 'offset': 3})
master.rulers().add({'link': "arpeggio.rate.auto", 'position': [15, 1], 'lines': [4, 4, 4, 1], 'offset': 3})
...
master.rulers().add({'link': "cc.value.auto", 'position': [4, 1], 'lines': [0]})
master.rulers().add({'link': "cc.value.auto", 'position': [5, 1], 'lines': [127]})
master.rulers().add({'link': "cc.value.auto", 'position': [9, 1], 'lines': [64]})
