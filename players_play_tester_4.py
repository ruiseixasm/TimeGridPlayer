...
pattern.rulers()\
    .add({'link': "note", 'lines': 1})\
    .add({'link': "note.channel.staff", 'lines': 10})\
    .add({'link': "note.velocity.staff", 'lines': 100})\
    .add({'link': "note.key", 'lines': 42})\
    .print()

master.rulers()\
    .add({'link': "pattern", 'lines': 1})\
    .add({'link': "pattern.repeat", 'lines': 7})\
    .print()

stage.json_save("players_play_tester_4.json")

# stage.json_load("players_play_tester_4.json").print()
